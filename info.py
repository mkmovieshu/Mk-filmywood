...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', ' -1002336864238 -1002344843738 -1001543897566 ').split()]  # For Multiple Id Use One Space Between Each.
