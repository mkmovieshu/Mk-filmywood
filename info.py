...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002240281827'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', ' -1002336864238 -1002344843738 -1001543897566 -1003298840050 -1001673585958 -1001677901864').split()]  # For Multiple Id Use One Space Between Each.
